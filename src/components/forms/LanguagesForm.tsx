...
const LanguagesForm = ({ cv, onChange }: LanguagesFormProps) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-900 mb-2">Languages</h2>
        <p className="text-slate-600">Add your language skills and proficiency levels</p>
      </div>
        ...
        {languages.map((lang) => (
          <div key={lang.id} className="border border-slate-200 rounded-lg p-4 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                <Label htmlFor={`proficiency-${lang.id}`}>Proficiency Level</Label>
                <Select
              ...
              <div>
                <Label htmlFor={`score-${lang.id}`}>Score (Optional)</Label>
                <Input
                  id={`score-${lang.id}`}
                  value={lang.score}
